...
const productsResource: ApiResource = {
    name: 'products',
    path: '/docs/resources/partner/products',
    description:
    ...
    endpoints: [
        ...
        },
        {
            ...
            requiredAttributes: [
                {
                    name: 'product',
                    type: 'string',
                    description: 'The unique code of product',
                },
                {
                    name: 'return_rate',
                    type: 'number',
                    description: 'Expected Rate of Return (XIRR) for the bond',
                },
                {
                    name: 'units',
                    type: 'number',
            ...
            request: {
                curl: `curl \n
                --request GET '{base_url}/products/{product}/price?units={units}&return_rate={return_rate}' \n
                --header 'Authorization: Bearer {api_token}'`,
            },
            response: {
                success: true,
        ...
        },
        {
            ...
            path: '/products/:isin',
            title: 'Get a product',
            description: 'This endpoint allows you to retrieve a specific product using its ISIN.',
            optionalAttributes: [],
            requiredAttributes: [
                {
                    name: 'isin',
                    type: 'string',
                    description: 'The unique ISIN code of product',
                },
            ],
            request: {
                curl: `curl \n
                --request GET '{base_url}/products/{isin}' \n
                --header 'Authorization: Bearer {api_token}'`,
            },
            response: {
                success: true,
